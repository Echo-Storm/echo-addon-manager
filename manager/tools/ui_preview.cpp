...
int main(int argc, char** argv) {
    ...
    AddonInfo a, b, c;
    a.id = "DLSS5NR01"; a.manifest.name = "DLSS 5 Neural Rendering"; a.manifest.version = "0.2.1"; a.manifest.author = "andreiday / Echo-Storm"; a.hModule = (HMODULE)1; a.enabled = true;
    ...
    // 4. Logs tab, with a few typical lines (sample data, like the rest of the preview)
    {
        ...
        LOG_INFO("AddonManager", "Loaded 'DLSS5NR01' %s", "0.2.1");
