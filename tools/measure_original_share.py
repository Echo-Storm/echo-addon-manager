r"""How much of the manager's source is still the code this project started from?
    ...
    python tools\measure_original_share.py <folder holding the original's src\ and sdk\> [--files]
...
To get the original, check out FrankBarretta/LosslessProxy at v0.3.0 (commit 6ca17e1) and point this at its LosslessProxy folder.
"""
import collections
import os
import re
...
theirs = sys.argv[1] if len(sys.argv) > 1 else None
